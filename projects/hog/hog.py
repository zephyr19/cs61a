...
def is_swap(player_score, opponent_score):
    ...
    """
    # BEGIN PROBLEM 4
    if get_leftmost_digit(player_score) * (player_score % 10) \
       == get_leftmost_digit(opponent_score) * (opponent_score % 10):
        return True
    return False
    # END PROBLEM 4

def get_leftmost_digit(num):
    """return the leftmost digit of the param num

    >>> get_leftmost_digit(0)
    0
    >>> get_leftmost_digit(34)
    3
    """
    leftmost_digit = 0
    while num > 0:
...
def play(strategy0, strategy1, score0=0, score1=0, dice=six_sided,
    ...
    # BEGIN PROBLEM 6
        ...
        previous0 = 0  # player0's dice num in the previous turn
        previous1 = 0
        while True:
            if player == 0:
                dice_num = strategy0(score0, score1)
                if abs(dice_num-previous0) == 2:
                    score0 += 3
                score0 += take_turn(dice_num, score1, dice)
                previous0 = dice_num
            else:
                dice_num = strategy1(score1, score0)
                if abs(dice_num-previous1) == 2:
                    score1 += 3
...
def max_scoring_num_rolls(dice=six_sided, num_samples=1000):
    ...
    for x in range(10, 0, -1):
        ...
        if score >= max_score:
            max_score = score
            num_roll = x
    # return the max_score for margin in the final strategy
    # return num_roll, max_score
    # PROBLEM 9 solution
    return num_roll
    # END PROBLEM 9
...
def swap_strategy(score, opponent_score, margin=8, num_rolls=4):
    ...
    if is_swap(new_score, opponent_score):
        if opponent_score > new_score or opponent_score - score >= margin:
            return 0
    else:
...
def final_strategy(score, opponent_score):
    ...
    *** YOUR DESCRIPTION HERE ***
    """
    # BEGIN PROBLEM 12
    # num_rolls, margin = max_scoring_num_rolls(100)
    # num_rolls and margin are calculated by the max_scoring_num_rolls function
